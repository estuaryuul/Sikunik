                        ...
                        <tr> <!-- Tambahkan baris ini -->
                            ...
                            {{-- <td>
                                @if (!empty($tamu->ulasan))
                                    <p><strong>Ulasan : </strong><em>{{ $tamu->ulasan }}</em></p>
                                @else
                                    <p>Sedang Diproses</p>
                                @endif
                            </td> --}}
                            ...
                            <td style="text-align: center;"> <!-- Tambahkan kolom untuk tombol -->
                                <a href="{{ route('assign.edit', $tamu->id) }}" class="btn btn-success btn-sm mb-2">Isi
                                    Hasil</a>
                            </td>
                        </tr> <!-- Tambahkan baris ini -->
                        @php $i++; @endphp
...
@endsection
{{-- @if (!empty($tamu->mentor))
                                    <p><strong>Mentor : </strong><em>{{ $tamu->mentor }}</em></p>
                                @else
                                    <p>Sedang Diproses</p>
                                @endif --}}
